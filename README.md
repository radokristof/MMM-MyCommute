...
`origin`                            | **REQUIRED** The starting point for your commute. Usually this is your home address.<br><br>**Type:** `string`<br>This is as you would see it Google Maps. Example: `65 Front St W, Toronto, ON M5J 1E6`. Alternatively you can use GPS coordinates here.
...
`arrivalTimeFormat`                 | If `showArrivalTime` is set to `true`, you can specify the arrival time format with this. <br><br>**Type:** `string`<br>Defaults to `HH:mm`.
